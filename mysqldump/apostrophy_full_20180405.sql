...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=latin1 COMMENT='Table to store results from ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `result` VALUES (4,1,'2018-03-31','SIM',NULL,NULL),(5,10,'2018-03-31','SIM',NULL,NULL),(6,10,'2018-03-31','SIM',NULL,NULL),(7,10,'2018-04-04','SIM',NULL,NULL),(8,10,'2018-04-05','PRAC',1,'Grammar'),(9,10,'2018-04-05','SIM',NULL,NULL),(10,11,'2018-04-05','PRAC',2,'Grammar'),(11,11,'2018-04-05','SIM',NULL,'ALL');
...
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=latin1 COMMENT='Table to match user option to a result line';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_user` VALUES (1,'Test','User','test@test.com','pbkdf2:sha256:50000$'),(2,'Matt','Ball','matt@ball.com','password123'),(3,'Janel','Yousif','janel@gmail.com','pbkdf2:sha256:50000$'),(4,'test','test','test@terst.com','123456'),(5,'ben2','wyatt','testest@masidfas.com','123123123123'),(8,'test222','teest','2131231@sdfsf.com','12312312313'),(9,'test222222','teest','2131231@sdfsfsss.com','12312312313'),(10,'matt','blaul','matt@blaul.com','123456'),(11,'Matt','Blaul','matt@blaul2.com','pbkdf2:sha256:50000$WwtmScng$444d51bb6f4d707a6e3c1a46d9b785310088275de7184ee64e3719ba28ae7071');
...
-- Dump completed on 2018-04-05 22:12:22
