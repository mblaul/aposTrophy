...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`mblaulou`@`%` PROCEDURE `sp_authenticateUser`(IN `p_username` VARCHAR(20), IN `p_password` VARCHAR(20))
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`mblaulou`@`%` PROCEDURE `sp_generateSimExam`()
    NO SQL
...
-- Dump completed on 2018-03-20 19:13:42
